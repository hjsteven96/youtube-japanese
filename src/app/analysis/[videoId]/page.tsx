...
import AnalysisPageWrapper, {
    GeminiResponseData,
} from "./analysis-client-page";
...
export default async function AnalysisPage({
     ...
     */
    const generateLearningResourceSchema = (
        ...
        const learningExpressions = data.analysis.slang_expressions
            .map((e) => e.expression)
            .join(", ");
        const timeRequired = data.duration
            ? `PT${Math.floor(data.duration / 60)}M${data.duration % 60}S`
            : undefined;
    ...
    const learningResourceSchema =
        generateLearningResourceSchema(initialAnalysisData);
